...
namespace core
{
    ...
    {
        texture_manager::instance().load_texture("../share/test_game/images/ground_tile.png", "ground_tile", _renderer);
        texture_manager::instance().load_texture("../share/test_game/images/lava_tile.png", "lava_tile", _renderer);
        ...
        texture_manager::instance().load_texture(
            "../share/test_game/images/boulder_spike_0.png", "boulder_spike_0", _renderer);
        texture_manager::instance().load_texture(
            "../share/test_game/images/boulder_spike_1.png", "boulder_spike_1", _renderer);
        texture_manager::instance().load_texture(
            "../share/test_game/images/boulder_spike_2.png", "boulder_spike_2", _renderer);
        texture_manager::instance().load_texture(
            "../share/test_game/images/boulder_spike_3.png", "boulder_spike_3", _renderer);
