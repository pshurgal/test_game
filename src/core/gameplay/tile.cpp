...
namespace core
{
    namespace gameplay
    {
        tile::tile( int32_t field_x, int32_t field_y, bool reachable, const std::string& ground_texture_id,
        ...
        {
            math::vec2 a = { _world_pos.x + 4,
                             _world_pos.y + 1 + (50 - 2) / 4 };
            math::vec2 b = { _world_pos.x + 4 + (50 - 8) / 2,
                             _world_pos.y + 1 };
            math::vec2 c = { _world_pos.x + 4 + (50 - 8),
                             _world_pos.y + 1 + (50 - 2) / 4 };
            math::vec2 d = { _world_pos.x + 4 + (50 - 8) / 2,
                             _world_pos.y + 1 + (50 - 2) / 2 };
        ...
        tile_p create_tile( int32_t field_x, int32_t field_y, bool reachable, const std::string& ground_texture_id,
                            const std::string& lava_texture_id )
        {
